...
class InvalidInvoiceFormatException extends Exception{
    ...
    public String getMessage(){
        return "Invalid invoice found among the invoices. Invoices contains either missing or extra dash, space, comma, task or amount";
    }
}
...
public class InvoiceGeneratorForFreelancers2 {
    ...
    public static String[] parseInvoice(String invoices) throws InvalidInvoiceFormatException{
